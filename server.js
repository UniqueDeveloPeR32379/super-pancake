...
const log = client.channels.get('589010228037681181') // Logging channel

const serverStats = {
  guildID: '533978054272483358',
  totalUsersID: '595167278157398016',
  memberCountID: '589010228037681181',
  botCountID: '589010228037681181'
}

var ownerId = '486817898078404621'; //My ID
...
client.on('guildCreate', guild => { // If the Bot was added on a server, proceed
  ...
  client.on('guildMemberAdd', member => {
    member.guild.channels.get('570196133507497985').send(`Welcome + ${member.tag} + To server`); 
});
